...
import f.s.fadminperm.biz.GroupBiz;
import f.s.fadminperm.biz.ResourceAuthorityBiz;
import f.s.fadminperm.constant.AdminCommonConstant;
import f.s.fadminperm.entity.Group;
import f.s.fadminperm.vo.AuthorityMenuTree;
import f.s.fadminperm.vo.GroupTree;
import f.s.fadminperm.vo.GroupUsers;
 ...
 */
@Controller
@RequestMapping("/admin/perm/group")
@Api("群组模块")
